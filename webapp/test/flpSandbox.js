		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Unit Tests",
									"targetURL": "#studentcomsaptrainingux402qunitux402qunit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"studentcomsaptrainingux402qunitux402qunit-display": {
								"semanticObject": "studentcomsaptrainingux402qunitux402qunit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student.com.sap.training.ux402.qunit.ux402qunit",
									"url": sap.ui.require.toUrl("student/com/sap/training/ux402/qunit/ux402qunit")
								}
							}
						}
					}
